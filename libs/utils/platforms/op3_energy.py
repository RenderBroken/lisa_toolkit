...
silver_cpu_active_states = OrderedDict([
    ...
    ( 422400, ActiveState(capacity=225, power=133)),
    ( 480000, ActiveState(capacity=257, power=160)),
    ( 556800, ActiveState(capacity=281, power=182)),
    ( 652800, ActiveState(capacity=315, power=210)),
    ( 729600, ActiveState(capacity=368, power=251)),
    ( 844800, ActiveState(capacity=406, power=306)),
    ( 960000, ActiveState(capacity=469, power=379)),
    (1036800, ActiveState(capacity=502, power=438)),
    (1113600, ActiveState(capacity=538, power=494)),
    (1190400, ActiveState(capacity=581, power=550)),
    (1228800, ActiveState(capacity=611, power=613)),
    (1324800, ActiveState(capacity=648, power=670)),
    (1401600, ActiveState(capacity=684, power=752)),
    (1478400, ActiveState(capacity=729, power=848)),
...
gold_cpu_active_states = OrderedDict([
    ...
    ( 403200, ActiveState(capacity=188, power=111)),
    ( 480000, ActiveState(capacity=225, power=133)),
    ( 556800, ActiveState(capacity=257, power=160)),
    ( 652800, ActiveState(capacity=281, power=182)),
    ( 729600, ActiveState(capacity=315, power=210)),
    ( 806400, ActiveState(capacity=348, power=252)),
    ( 883200, ActiveState(capacity=374, power=290)),
    ( 940800, ActiveState(capacity=428, power=332)),
    (1036800, ActiveState(capacity=469, power=379)),
    (1113600, ActiveState(capacity=502, power=438)),
    (1190400, ActiveState(capacity=538, power=494)),
    (1248000, ActiveState(capacity=581, power=550)),
    (1324800, ActiveState(capacity=611, power=613)),
    (1401600, ActiveState(capacity=648, power=670)),
    (1478400, ActiveState(capacity=684, power=752)),
    (1555200, ActiveState(capacity=729, power=848)),
    (1632000, ActiveState(capacity=763, power=925)),
    (1708800, ActiveState(capacity=795, power=1018)),
    (1785600, ActiveState(capacity=832, power=1073)),
    (1824000, ActiveState(capacity=868, power=1209)),
    (1920000, ActiveState(capacity=905, power=1298)),
    (1996800, ActiveState(capacity=952, power=1428)),
    (2073600, ActiveState(capacity=979, power=1521)),
